...
const HeroSection = ({ language }: HeroSectionProps) => {
  const content = {
    es: {
      ...
      subtitle: 'Un lugar donde la fe, la esperanza y el amor se encuentran. Te invitamos a ser parte de nuestra familia de fe',
      cta: 'Conoce Más',
      visit: 'Visítanos'
    },
    en: {
      title: 'Seventh-day Adventist Church - Miramonte',
      subtitle: 'A place where faith, hope, and love come together. We invite you to be part of our faith family',
      cta: 'Learn More',
      visit: 'Visit Us'
    }
  };
    ...
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10 pt-24">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-amber-100 mb-10 max-w-3xl mx-auto leading-relaxed drop-shadow-md font-medium">
            {t.subtitle}
          </p>
